...
<!-- SYNC_STATUS_START -->
**Last updated:** 2026-07-25T05:51:28Z
...
- **`bishengjdk-build`** — bootjdk/jdk25/OpenJDK25U-jdk_aarch64_linux_hotspot_25.0.1_8.tar.gz is 133.16 MB, exceeds GitHub 100 MB limit<br>🔍 Source: accessible<br>🔍 Destination: exists<br>🔍 Cached: not found (download may have failed)
...
- **`intel-kernel`** — Cannot delete 'master)' (current default branch on destination)<br>🔍 Source: accessible<br>🔍 Destination: Repo is very large (2674MB) — may have timed out<br>🔍 Cached: not found (download may have failed)
...
- **`mugen`** — testcases/cli-test/squashfs-tools/common/initrd.img is 68.38 MB, exceeds GitHub 100 MB limit<br>🔍 Source: accessible<br>🔍 Destination: exists<br>🔍 Cached: not found (download may have failed)
